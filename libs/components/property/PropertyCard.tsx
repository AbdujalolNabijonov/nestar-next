...
interface PropertyCardType {
	...
	likePropertyHandle: any
}

const PropertyCard = (props: PropertyCardType) => {
	const { property, likePropertyHandler, myFavorites, recentlyVisited, likePropertyHandle } = props;
					...
					<Stack className="type-buttons">
						...
						{!recentlyVisited && (
							<Stack className="buttons">
								...
								<IconButton color={'default'} onClick={() => likePropertyHandle(user, property?._id)}>
									{myFavorites ? (
